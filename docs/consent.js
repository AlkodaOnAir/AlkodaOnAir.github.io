...
(function(){
  ...
  var CSS=[
    ...
    '#alkoda-cb-accept,#alkoda-cb-refuse{flex:1;min-height:44px;border-radius:999px;font-size:13px;font-weight:700;cursor:pointer;border:1px solid transparent;transition:.2s;font-family:inherit;line-height:1}',
    '#alkoda-cb-accept{background:#00d2ff;color:#03080f;border-color:#00d2ff}',
    '#alkoda-cb-accept:hover{background:#fff;border-color:#fff}',
    '#alkoda-cb-refuse{background:transparent;color:#9db0d0;border-color:#22314f}',
    '#alkoda-cb-refuse:hover{border-color:#00d2ff;color:#00d2ff}',
